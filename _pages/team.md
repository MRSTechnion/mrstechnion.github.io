...
<div class="people">
 ...
 <div class="grid-item">
        <div class="card hoverable">
          <img src="../assets/img/people/andrey_zhitnikov.jpeg">
          <div class="card-body">
          <center>
            <h2 class="card-title text"> Andrey Zhitnikov</h2>
            <p class="card-text">Postdoctoral Scholar</p>
          </center>
          </div>
        </div>
  </div>
...
<div class="grid-item">
        ...
        <a href="https://il.linkedin.com/in/yaniv-hassidof-7885191b8" target="_blank">
          ...
          <center>
            ...
            <p class="card-text">PhD Student (direct)</p>
          </center>
          </div>
        </div>
  </div>
  ...
  <div class="grid-item">
        <div class="card hoverable">
          ...
          <center>
            ...
            <p class="card-text"> PhD Student (direct) <br> &nbsp; </p>
          </center>
          </div>
        </div>
  </div>
